...
public class InterfazAutenticacion extends javax.swing.JFrame {

    InterfazUsuario usuarioGUI = new InterfazUsuario();
        
    public InterfazAutenticacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SISTEMA PRESTA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pw = jPasswordField1.getText();
            if (correo.equals("osmar.torres@uabc.edu.mx") && pw.equals("abc123")){
                usuarioGUI.setCorreo(correo);
                this.setVisible(false); // dispose();
                usuarioGUI.setVisible(true);
                usuarioGUI.hacerVisibleVistaAdmin();
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAutenticacion().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public static javax.swing.JTextField correoField;
